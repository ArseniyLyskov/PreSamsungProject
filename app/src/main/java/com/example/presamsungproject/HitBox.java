...
import com.example.presamsungproject.Geometry.Square;
...
public class HitBox implements Serializable {
    ...
    public void scaleTo(double koeff) {
        square.scaleTo(koeff);
    }

    public void draw(Canvas canvas) {
        Path path = new Path();
        path.moveTo(square.getP1().getX(), square.getP1().getY());
        path.lineTo(square.getP2().getX(), square.getP2().getY());
        path.lineTo(square.getP3().getX(), square.getP3().getY());
        path.lineTo(square.getP4().getX(), square.getP4().getY());
        path.lineTo(square.getP1().getX(), square.getP1().getY());
    ...
    public void updateProperties(double x, double y, double angle) {
        ...
        square = new Square(new Point(x1, y1), new Point(x2, y2), new Point(x3, y3), new Point(x4, y4));
    }
}